#strong
loot spawn ~ ~0.5 ~ loot enchantplus:ench_diamond_chestplate_strong
...
kill @e[type=item,distance=..1,limit=1,sort=nearest,nbt={Item:{id:"minecraft:diamond_chestplate"}}]