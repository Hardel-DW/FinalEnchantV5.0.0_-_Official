#strong
loot spawn ~ ~0.5 ~ loot enchantplus:ench_chainmail_leggings_strong
...
kill @e[type=item,distance=..1,limit=1,sort=nearest,nbt={Item:{id:"minecraft:chainmail_leggings"}}]