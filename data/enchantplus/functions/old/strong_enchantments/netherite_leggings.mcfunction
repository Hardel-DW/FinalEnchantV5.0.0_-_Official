#strong
loot spawn ~ ~0.5 ~ loot enchantplus:ench_netherite_leggings_strong
...
kill @e[type=item,distance=..1,limit=1,sort=nearest,nbt={Item:{id:"minecraft:netherite_leggings"}}]