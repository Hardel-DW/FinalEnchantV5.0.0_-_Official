#strong
loot spawn ~ ~0.5 ~ loot enchantplus:ench_chainmail_chestplate_strong
xp add @p[scores={LapisCount=3..,Drop=1..}] -3 levels
clear @p[scores={LapisCount=3..,Drop=1..}] lapis_lazuli 3
...
kill @e[type=item,distance=..1,limit=1,sort=nearest,nbt={Item:{id:"minecraft:chainmail_chestplate"}}]